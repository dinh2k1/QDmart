...
<head>
    ...
    <title>QDmart - Chi tiết sản phẩm</title>
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="product-details-content quickview-content ml-25px">
                            ...
                            <div class="pro-details-quality">
                                ...
                                <div class="pro-details-compare-wishlist pro-details-wishlist" style="height:50px; width:55px; font-size:33px; border:1px solid; border-radius:5px; background-color:#ffd400; margin-left:5px; padding:5px;" >
                                    <form>
                                        <button 
                                            name="id_yeuthich"
