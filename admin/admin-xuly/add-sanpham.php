...
?>
                        <form class="contact-form-style" action="" method="post" enctype="multipart/form-data">
                            <div class="row">
								...
								<div class="col-lg-6">
									<input name="gia-sp" placeholder="Giá sản phẩm" type="number"  />
								</div>
								<div class="col-lg-6">
									<input name="gia-km-sp" placeholder="Giá khuyến mãi" type="number"  />
								</div>
								...
								<div class="col-lg-6">
									<input name="soluong-sp" placeholder="Số lượng" type="number"  />
								</div>
								<div class="col-lg-6">
