            ...
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <div class="welcome-text">
						...
						<li>&ensp;|&ensp;</li>
						<li><a class="single-link" href="mailto:vuquandinh2001@gmail.com"><i class="fa fa-comment" aria-hidden="true"></i>Phản hồi</a></li>	
                    </div>
                </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-3 col">
                    <div class="header-logo">
                        <a href="index.php"><img src="assets/images/logo/qd.png" alt="Site Logo" width="100%;"/></a>
                    </div>
                </div>
				<!-- thanh tìm kiếm -->
